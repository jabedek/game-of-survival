...
import { BoardFields } from './fields.types';
...
export class FieldsComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    // console.log(this.hostRect.bottom - this.hostRect.top);
  ...
  ngAfterViewInit() {
    ...
    // console.log(this.refs[0].nativeElement.getBoundingClientRect());

    // console.log(this.refs[0].nativeElement.getBoundingClientRect());
    // const rect = this.refs[0]?.nativeElement.getBoundingClientRect();

    // console.log('>>', rect);
    // console.log(this.fieldsTemplates[0]);
    // console.log(this.fieldsRefs);
  }
